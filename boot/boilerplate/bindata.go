...
func infrastructure_envMainTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "infrastructure/_env/main.tf", size: 159, mode: os.FileMode(420), modTime: time.Unix(1458661096, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func infrastructureModulesIamIamTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "infrastructure/modules/iam/iam.tf", size: 631, mode: os.FileMode(420), modTime: time.Unix(1458661091, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
