...
func nodeGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "node.go", size: 126, mode: os.FileMode(420), modTime: time.Unix(1450570573, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
